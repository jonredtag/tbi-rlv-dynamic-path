         ...
         <div class="d-md-flex text-center text-md-left pt-3 pb-3 border-bottom align-items-center">
            <div class="col-5 col-sm-4 offset-3 offset-sm-4 offset-md-0 col-md-2 col-lg-2 pl-0">
                <a href="//www.lastminuteclub.com/">
                    <img src="https://lastminuteclub.s3.us-east-2.amazonaws.com/img/branding/lastminuteclub-logo.svg" alt="redtag Logo" class="logo w-100 loading" data-was-processed="true">
                </a>
            </div>  
            <div class="col-md-6 col-lg-4 col-xl-5 text-center text-md-left">
                <small>@lang('common.footer_copyright') lastminuteclub.com</small>
