<footer class="footer-secondary mt-5  payment border-top">
     <div class="container">
         <div class="d-md-flex text-center text-md-left pt-3 pb-3 border-bottom align-items-center">
             <div class="col-4 col-sm-3 offset-4 offset-sm-5 offset-md-0 col-md-2 col-lg-1 px-0">
                 <a href="/">
                     <img src="https://redtag-ca.s3.amazonaws.com/img/branding/logo-redtag-2021.svg" alt="redtag Logo" class="logo w-100 loading" data-was-processed="true">
                 </a>
             </div>
             <div class="col-md-6 col-lg-4 col-xl-5 text-center text-md-left">
                <small>@lang('common.footer_copyright') redtag.ca</small>
            ...
            <div class="text-center text-md-right text-lg-left mt-3 mt-md-0 ml-auto">
                 ...
                 <div class="d-sm-inline-block text-sm-right mt-3 mt-sm-0">
                    ...
                    <?php } ?>
                    <?php if(date('Y-m-d') <= '2022-04-15') { ?>
                        <div><strong>@lang('common.good_friday')</strong></div>
                    <?php } ?>
                 </div>
            </div>
         </div>
