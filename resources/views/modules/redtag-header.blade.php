    ...
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <a href="https://www.redtag.ca">
                <img src="https://redtag-ca.s3.amazonaws.com/img/branding/logo-redtag-2021.svg" alt="redtag Logo" class="logo" />
            </a>
            <a class="header-phone-number-mobile d-md-none" href="tel:18665733824">@lang('common.150_agents') | 1-866-573-3824</a>
            <div class="d-none d-md-flex">
                <a class="btn-link btn-unstyled d-flex flex-column align-items-center justify-content-center  black-text" href="https://www.redtag.ca/fr/">FR</a>
                <div id="pro_section" class="main-header-login  d-flex align-items-center"></div>
            </div>
    ...
    <section id="navbar-mobile" role="navigation" class="navbar navbar-out">
        <div class="nav navbar-nav container justify-content-between" role="menubar">
            <a class="nav-link nav-border-bottom active " href="https://www.redtag.ca" role="menuitem">
                <svg class="icon d-md-none " xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <use xlink:href="/img/icons/icon-defs.svg#icon-home"></use>
                </svg>
                <span class="nav-title">@lang('common.home')</span>
                <svg class="icon-arrow d-md-none " xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <use xlink:href="/img/icons/icon-defs.svg#icon-chevron-right"></use>
                </svg>
            </a>
            <a class="nav-link nav-border-bottom " href="https://www.redtag.ca/vacation-packages.php" role="menuitem">
                <svg class="icon d-md-none " xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <use xlink:href="/img/icons/icon-defs.svg#icon-palm-trees"></use>
                </svg>
            ...
            <a class="nav-link nav-border-bottom " href="https://www.redtag.ca/flight-hotel/" role="menuitem">
                <svg class="icon d-md-none " xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <use xlink:href="/img/icons/icon-defs.svg#icon-flight-hotel"></use>
                </svg>
            ...
            <a class="nav-link nav-border-bottom " href="https://www.redtag.ca/flights.php" role="menuitem">
                <svg class="icon d-md-none " xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <use xlink:href="/img/icons/icon-defs.svg#icon-plane-right"></use>
                </svg>
            ...
            <a class="nav-link nav-border-bottom" href="https://www.redtag.ca/hotels.php" target="_blank" role="menuitem">
                <svg class="icon d-md-none " xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <use xlink:href="/img/icons/icon-defs.svg#icon-bed"></use>
                </svg>
            ...
            <a class="nav-link nav-border-bottom " href="https://www.redtag.ca/car-rental.php" role="menuitem">
                <svg class="icon d-md-none " xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <use xlink:href="/img/icons/icon-defs.svg#icon-car"></use>
                </svg>
            ...
            <a class="nav-link nav-border-bottom" href="https://www.redtag.ca/deals.php" role="menuitem">
                <svg class="icon tag d-md-none " xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <use xlink:href="/img/icons/icon-defs.svg#icon-tag"></use>
                </svg>
            ...
            <a class="nav-link nav-border-bottom" href="https://www.redtag.ca/cruises.php" role="menuitem">
                <svg class="icon d-md-none " xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <use xlink:href="/img/icons/icon-defs.svg#icon-cruise"></use>
                </svg>
            ...
            <a class="nav-link nav-call-button d-md-none " href="tel:18665733824" role="menuitem">
                <svg class="icon d-md-none " xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <use xlink:href="/img/icons/icon-defs.svg#icon-phone"></use>
                </svg>
            ...
            <a class="nav-link d-md-none nav-border-bottom" href="https://www.redtag.ca/newsletter" role="menuitem">
                <svg class="icon d-md-none " xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <use xlink:href="/img/icons/icon-defs.svg#icon-mail"></use>
                </svg>
