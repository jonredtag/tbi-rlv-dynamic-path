     ...
     <div class="container">
         <div class="d-md-flex text-center text-md-left pt-3 pb-3 border-bottom align-items-center">
             <div class="col-4 col-sm-3 offset-4 offset-sm-5 offset-md-0 col-md-2 col-lg-1 px-0">
                 <a href="/">
                     <img src="https://travel-img-assets.s3.us-west-2.amazonaws.com/logos/logo-hsbc-red.png" alt="HSBC Logo" class="logo w-100 loading" data-was-processed="true">
                 </a>
             </div>
             <div class="col-md-6 col-lg-4 col-xl-5 text-center text-md-left">
                {{-- <small>@lang('common.footer_hsbc_copyright') redtag.ca</small> --}}
                ...
                <div class="col-md-6 col-lg-8 text-center text-md-left text-muted">
                 ...
                 <div class="col-md-6 col-lg-4 ">
                     <div class="d-lg-flex justify-content-end text-md-right text-center mt-3 mt-md-0">
                         <div>
                            <div>
                                {{-- <small> 885 West Georgia Street, Vancouver, British Columbia, V6C 3E9</small> --}}
                            </div>
                         </div>
                     </div>
                </div>
